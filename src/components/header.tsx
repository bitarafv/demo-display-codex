...
export function Header() {
  ...
  return <header className="sticky top-0 z-40 border-b border-[var(--line)] bg-[color:var(--bg)]/80 backdrop-blur-xl">
    <div className="shell flex h-16 items-center gap-4">
      ...
      <nav className="ml-auto hidden items-center gap-6 text-sm font-semibold md:flex"><Link href="/markets">Solutions</Link><Link href="/discussion">Discussion</Link><Link href="/about">About</Link></nav>
